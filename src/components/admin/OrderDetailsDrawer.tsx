...
const OrderDetailsDrawer = ({
  ...
  const filteredPackages = useMemo(() => {
    if (!itemSearchInput.trim())
      return availablePackages.filter((pkg) => pkg.status === "active");
    ...
    <Drawer open={isOpen} onOpenChange={onClose}>
      <DrawerContent className="overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <h3 className="mb-3 font-semibold text-[#170A11B2] text-[18px]">
              Order Summary
            </h3>
            <div
              className={
                isEditing ? "space-y-3" : "grid grid-cols-2 gap-4 text-sm"
              }
            >
              <div>
          ...
          {/* Delivery Location */}
          <div>
            <label className="text-sm text-[#170A11B2] ">
              Delivery Location
            </label>
            {isEditing ? (
              <Input
                        ...
                        filteredPackages.map((pkg) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-gray-500">
                                ₵{(pkg.price - pkg.discount).toLocaleString()} (
                    ...
                    <div className="flex gap-3 items-start">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start gap-2">
                          ...
                          <p className="text-xstext-gray-900 flex-shrink-0">
                            ₵
                            {(
